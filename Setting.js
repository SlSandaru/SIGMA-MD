...
global.owner = process.env.OWNER_NUMBER  || '94740273578' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://sandaru:sandu123@cluster0.piqcnbr.mongodb.net/" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.sudo  =  process.env.SUDO || "94740273578" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"🅼♥︎❚❚♥︎🆉",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://chat.whatsapp.com/HIO92Q1EwkqLPsLC72Gi3z' ; 
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '31_03_2024_SIGMA_MD_qGd4JHLi_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'sɪɢᴍᴀ-ᴍᴅ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `𓄂 𝙰𝙻𝚘𝚗𝚎 𝚜𝚊𝚓𝚊࿐`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || '𓄂 𝙰𝙻𝚘𝚗𝚎 𝚜𝚊𝚓𝚊࿐',      // ADD YOUR STICKER AUTHOR NAME
